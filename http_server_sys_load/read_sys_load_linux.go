...
// GetDiskUsage based on command "df",
// example result: "Disk Usage: 68.4/112.7 GiB (65%)"
...
// GetMemoryUsage based on command "free -m",
// example result: "Memory Usage: 8248/15990 MiB (51.58%)"
...
// GetCPUAverageUsage based on command "mpstat" (apt package "sysstat"),
// returns CPU average usage percentage in the last 1 second,
// example result: "CPU Usage: 12.06%"
...
// GetCPUModel based on command "lscpu",
// example result: "16 cores (Intel(R) Xeon(R) CPU E5-2670 0 @ 2.60GHz, 2 socket)"
func GetCPUModel() string {
	...
	// lscpu | grep -aiE 'socket|model name'
	// println(lscpuStdout)
